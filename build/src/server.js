...
exports.startElasticSearch = exports.start = exports.authChannel = void 0;
...
function startQueues() {
    return __awaiter(this, void 0, void 0, function* () {
        exports.authChannel = (yield (0, connection_1.createConnection)());
    });
}
...
function authErrorHandler(app) {
    app.use((error, _req, res, next) => {
        (0, config_1.logger)("server.ts - authErrorHandler()").error(`AuthService ${error.comingFrom}:`, error);
...
function startServer(app) {
    try {
        ...
        (0, config_1.logger)("server.ts - startServer()").info(`AuthService has started with pid ${process.pid}`);
        httpServer.listen(Number(config_1.PORT), () => {
            (0, config_1.logger)("server.ts - startServer()").info(`AuthService running on port ${config_1.PORT}`);
        });
    }
    catch (error) {
        (0, config_1.logger)("server.ts - startServer()").error("AuthService startServer() method error:", error);
    }
}
